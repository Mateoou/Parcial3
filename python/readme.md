...
### 2️⃣ Ubicar la carpeta `proyecto`  
...
### 3️⃣ Abrir la terminal en la carpeta `proyecto`  
...
## 📝 Notas:
✅ La carpeta `images` **debe** existir dentro de `proyecto`, especialmente si el script usa imágenes.  
✅ Si el programa requiere librerías adicionales, instálalas con `pip install nombredelalibreria`.  
✅ Si tienes problemas, revisa la configuración de Python en tu sistema.  
